"""
Generate equity curves for all symbols from SHORT strategy trade logs
...
print("=" * 80)
print("GENERATING EQUITY CURVES FOR ALL SYMBOLS - SHORT STRATEGY")
print("=" * 80)

# Load trade logs
print("\n[1/5] Loading trade logs...")
trades_path = '/home/ubuntu/stage4_optimization/Best_Short_Strategy_ATR_Trailing_Trades.parquet'
...
csv_path = '/home/ubuntu/stage4_optimization/Best_Short_Strategy_Equity_Curves.csv'
equity_df.to_csv(csv_path, index=False)
print(f"✓ Saved to: {csv_path}")

# Also save to parquet
parquet_path = '/home/ubuntu/stage4_optimization/Best_Short_Strategy_Equity_Curves.parquet'
...
stats_path = '/home/ubuntu/stage4_optimization/Best_Short_Strategy_Symbol_Stats.csv'
...
ax1.set_title('All Symbol Equity Curves - SHORT Strategy (ATR Trailing Stop 1.5×)\n400 Symbols, $100K Starting Balance Each', 
             fontsize=14, fontweight='bold')
ax1.grid(True, alpha=0.3)
ax1.legend()

plt.tight_layout()
fig1_path = '/home/ubuntu/stage4_optimization/All_Equity_Curves_Short.png'
...
ax_top.set_title('Top 20 Performing Symbols - SHORT Strategy', fontsize=13, fontweight='bold')
...
ax_bottom.set_title('Bottom 20 Performing Symbols - SHORT Strategy', fontsize=13, fontweight='bold')
ax_bottom.grid(True, alpha=0.3)
ax_bottom.legend(loc='lower left', fontsize=7, ncol=2)

fig2_path = '/home/ubuntu/stage4_optimization/Top_Bottom_20_Equity_Curves_Short.png'
...
ax3.hist(stats_df['PctGain'], bins=50, color='coral', alpha=0.7, edgecolor='black')
...
ax3.set_title('Distribution of Final % Gains Across All Symbols\nSHORT Strategy (ATR Trailing Stop 1.5×)', 
             fontsize=14, fontweight='bold')
ax3.grid(True, alpha=0.3, axis='y')
ax3.legend(fontsize=11)

plt.tight_layout()
fig3_path = '/home/ubuntu/stage4_optimization/Pct_Gain_Distribution_Short.png'
