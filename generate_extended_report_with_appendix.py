...
"""
Generate Extended Performance Report with FIFO Methodology Appendix
"""
...
print("="*80)
print("GENERATING EXTENDED PERFORMANCE REPORT WITH APPENDIX")
print("="*80)
...
# APPENDIX
print("\n[3/5] Adding FIFO Methodology Appendix...")
...
appendix_sections = [
    ...
    ("Baseline vs Production", f"Baseline (theoretical) assumed every signal is taken with unlimited capital, resulting in 31,823 trades. Production (realistic) applies real fund constraints with 10-position limit and 10% sizing, resulting in 16,754 trades (52.6% of signals). The remaining 15,069 signals (47.4%) were skipped due to max positions reached. This demonstrates that the 10-position limit is the dominant constraint, causing nearly half of all signals to be skipped."),
...
print(f"  Total pages: ~7 (including appendix)")

print("\n" + "="*80)
print(f"Extended report with appendix saved to: {pdf_file}")
print("="*80)
